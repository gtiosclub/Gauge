...
//                    }
//                    .padding(.vertical, 6)
                    VoteCard(voterName: user.username, profilePhotoURL: user.profilePhoto, username: user.username, timeAgo: "", tags: [take.topic], vote: (selectedOption == 1 ? take.responseOption1 : take.responseOption2), content: take.question, comments: nil, views: nil, votes: nil)
                }
            }
        }
