                    ...
                    HStack {
                        VStack {
                            ...
                            Text(post.sublabel1)
                                ...
                                .font(.subheadline)
                                .opacity(max(0.0, (optionSelected == 1 && dragAmount.width == 0.0 ? 1.0 : (dragAmount.width == 0.0 ? (0.8) : (0.3 - (dragAmount.width / 125.0).magnitude)))))
                                .frame(width: 150.0, alignment: .leading)
                        ...
                        VStack {
                            ...
                            Text(post.sublabel2)
                                ...
                                .font(.subheadline)
                                .opacity(max(0.0, (optionSelected == 2 && dragAmount.width == 0.0 ? 1.0 : (dragAmount.width == 0.0 ? (0.8) : (0.3 - (dragAmount.width / 125.0).magnitude)))))
                                .frame(width: 150.0, alignment: .trailing)
                                .minimumScaleFactor(0.50)
                                .lineLimit(1)
                        }
